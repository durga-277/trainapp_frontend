          ...
          <div className="mb-8">
            <div className="bg-gray-50 p-4 rounded-lg space-y-4">
              ...
              <div className="space-y-2">
                <p className="text-sm"><span className="text-gray-600">Train:</span> Express {trainId}</p>
                <p className="text-sm"><span className="text-gray-600">Journey Date:</span> {journeyDate}</p>
